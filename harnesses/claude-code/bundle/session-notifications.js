...
import { readFileSync as readFileSync3, writeFileSync as writeFileSync3, mkdirSync as mkdirSync4, openSync, closeSync, unlinkSync as unlinkSync2, statSync } from "node:fs";
...
import { closeSync as closeSync2, mkdirSync as mkdirSync5, openSync as openSync2, readFileSync as readFileSync4, unlinkSync as unlinkSync3, writeFileSync as writeFileSync4 } from "node:fs";
...
async function fetchOpenGoals(creds, goalsTableName) {
  ...
  try {
    ...
    if (known && !known.includes(goalsTableName)) {
      log7(`fetchOpenGoals: table "${goalsTableName}" not present \u2014 skipping read`);
      return null;
    }
...
import { readFileSync as readFileSync9, writeFileSync as writeFileSync8, writeSync, mkdirSync as mkdirSync8, existsSync as existsSync5, unlinkSync as unlinkSync4, openSync as openSync4, closeSync as closeSync4, statSync as statSync3 } from "node:fs";
...
function withTimeout(p, ms, fallback) {
  return new Promise((resolve4) => {
    const t = setTimeout(() => resolve4(fallback), ms);
