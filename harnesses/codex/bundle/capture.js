...
// dist/src/hooks/codex/spawn-wiki-worker.js
var HOME = homedir11();
var wikiLogger = makeWikiLogger(join14(HOME, ".codex", "hooks"));
...
function spawnCodexWikiWorker(opts) {
  ...
  writeFileSync6(configFile, JSON.stringify({
    ...
    wikiLog: WIKI_LOG,
    hooksDir: join14(HOME, ".codex", "hooks"),
...
function isHivemindPluginEnabled() {
  try {
    const settingsPath = join15(homedir12(), ".claude", "settings.json");
...
import { existsSync as existsSync8, lstatSync as lstatSync2, mkdirSync as mkdirSync10, readFileSync as readFileSync10, renameSync as renameSync5, unlinkSync as unlinkSync5, writeFileSync as writeFileSync7 } from "node:fs";
...
function resolveEmbedDaemonPath() {
  return join19(dirname8(fileURLToPath3(import.meta.url)), "embeddings", "embed-daemon.js");
}
