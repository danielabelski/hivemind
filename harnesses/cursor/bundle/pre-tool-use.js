...
function privateStoreRoot() {
  return process.env.HIVEMIND_DOCS_PRIVATE_DIR || join17(homedir10(), ".hivemind", "docs-private");
}
...
function resolveEmbedDaemonPath() {
  return join18(dirname9(fileURLToPath2(import.meta.url)), "embeddings", "embed-daemon.js");
}
