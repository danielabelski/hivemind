...
// dist/src/hooks/cursor/spawn-wiki-worker.js
var HOME = homedir11();
var wikiLogger = makeWikiLogger(join14(HOME, ".cursor", "hooks"));
...
function spawnCursorWikiWorker(opts) {
  ...
  writeFileSync6(configFile, JSON.stringify({
    ...
    wikiLog: WIKI_LOG,
    hooksDir: join14(HOME, ".cursor", "hooks"),
...
function resolveEmbedDaemonPath() {
  return join22(dirname8(fileURLToPath3(import.meta.url)), "embeddings", "embed-daemon.js");
}
