...
import { readFileSync as readFileSync2, writeFileSync, writeSync, mkdirSync as mkdirSync2, existsSync as existsSync2, unlinkSync, openSync, closeSync, statSync } from "node:fs";
...
// dist/src/hooks/hermes/spawn-wiki-worker.js
var HOME = homedir5();
var wikiLogger = makeWikiLogger(join7(HOME, ".hermes", "hooks"));
...
function spawnHermesWikiWorker(opts) {
  ...
  writeFileSync2(configFile, JSON.stringify({
    ...
    wikiLog: WIKI_LOG,
    hooksDir: join7(HOME, ".hermes", "hooks"),
...
import { readFileSync as readFileSync4, writeFileSync as writeFileSync4, writeSync as writeSync2, mkdirSync as mkdirSync6, renameSync as renameSync2, rmdirSync, existsSync as existsSync5, lstatSync, unlinkSync as unlinkSync2, openSync as openSync2, closeSync as closeSync2 } from "node:fs";
