 ...
 *
 * Cadence + safety:
 *   - Throttled by `~/.deeplake/state/skilify/autopull-last-run.json`. Default
...
// used by src/skilify/pull.ts:resolvePullDestination().
 ...
 * leave a half-written timestamp file behind. Mirrors src/skilify/state.ts.
 */
